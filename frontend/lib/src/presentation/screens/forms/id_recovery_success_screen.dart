...
class IdRecoverySuccessScreen extends StatefulWidget {
  ...
  @override
  State<IdRecoverySuccessScreen> createState() => _IdRecoverySuccessScreenState();
}
...
class _IdRecoverySuccessScreenState extends State<IdRecoverySuccessScreen>
            ...
            child: SafeArea(
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    _buildTabItem(Icons.home_outlined, 'Home', true, () {
                      context.go('/home');
                    }),
                    _buildTabItem(Icons.apps_outlined, 'Services', false, () {
                      // Handle services navigation
                    }),
                    _buildTabItem(Icons.calendar_today_outlined, 'Appointments', false, () {
                      // Handle appointments navigation
                    }),
                    _buildTabItem(Icons.settings_outlined, 'Settings', false, () {
  ...
  Widget _buildTabItem(IconData icon, String label, bool isActive, VoidCallback onTap) {
